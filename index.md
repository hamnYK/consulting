...
|---|---|---|
| **인사이트 스캔**<br>**(Insight Scan)** | - 중요한 3가지 문제 도출<br>- 먼저 할 일과 기준 합의<br>- 세션 2회(10일 이내)<br>**- 90만 원** | - 문제의 범위와 평가 기준 정리<br>- 할 일의 순위 합의<br>- 다음 2 weeks의 체크포인트 설정<br>- 세션 3–4회(14일 이내)<br>**170만 원** |
